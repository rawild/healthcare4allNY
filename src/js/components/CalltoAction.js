...
export default class CalltoAction extends Component {
  ...
  _FlanaganCallScript() {
    return(<span>Hi, my name is __________ and I live in ____________. <br /> <br />
        ...
        (If you feel comfortable you can share a personal reason why this is important to you)<br /> <br /> 
        I am very disappointed that Senator Flanagan has failed to show leadership on this issue and did nothing to bring the New York Health Act to a vote this session.<br /> <br />
   ...
   _senators() {
    ...
    <SenatorProfile name="Kemp Hannon"
     ...
     him
     label="A"
     callScript={this._HannonCallScript()}/>
     <SenatorProfile name="John J. Flanagan"
         ...
         him
         label="B"
         callScript={this._FlanaganCallScript()}
       /> 
     </div>)
  }
  ...
  render() {
    ...
    var CuomoCallScript = () => {
      return(<span>Hi, my name is __________ and I live in ____________. <br /> <br />
          ...
          The New York Health Act will guarantee healthcare for all New Yorkers so that no resident will ever be denied care or face the threat of bankruptcy because of medical costs. <br /> <br /> 
          (If you feel comfortable you can share a personal reason why this is important to you)<br /> <br /> 
          I am very disappointed that Governor Cuomo has failed to show leadership on this issue and did nothing to bring the New York Health Act to a vote during the regular session.<br /> <br />
    ...
    return(<div className="CalltoAction">
      ...
      <div className="CTA-Targets" style={STYLES.ctaTargets}>
            ...
            <SenatorProfile name="Andrew Cuomo"
                ...
                title="Governor"
                img={Cuomo} 
                explainer="Ask why he didn't support the passage of health care for all New Yorkers and call on him to schedule a special session to pass the NY Health Act.  "
                facebook="https://www.facebook.com/GovernorAndrewCuomo"
                twitter=".@NYGovCuomo Why didn't you support the #NYHealthAct? Call a special session for it. We're looking to you to lead. #PassNYHealth"
                him
